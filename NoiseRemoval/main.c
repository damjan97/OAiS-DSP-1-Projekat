...
{   
    ...
    while(1)
	{
    	...
    	{
    		case 14:
    			printf("%d\tPrepoznata frekvencija: 880Hz\n", broj++);
    			for(i=0; i<AUDIO_IO_SIZE; i++)
    			{
    			...
    			break;
    		case 24:
    		    printf("%d\tPrepoznata frekvencija: 1540Hz\n", broj++);
    			for(i=0; i<AUDIO_IO_SIZE; i++)
    			{
    		...
    		case 25:
    		    ...
    		    break;
    		case 33:
    		    printf("%d\tPrepoznata frekvencija: 2100Hz\n", broj++);
    			for(i=0; i<AUDIO_IO_SIZE; i++)
    			{
    		...
    		case 34:
    		    ...
    		    break;
    		case 41:
    		    printf("%d\tPrepoznata frekvencija: 2560Hz\n", broj++);
    			for(i=0; i<AUDIO_IO_SIZE; i++)
    			{
